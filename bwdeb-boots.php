...
class BWDEBClassElementorBundle {
	...
	public function bwdeb_add_elementor_widget_categories( $elements_manager ) {
		$elements_manager->add_category(
			...
			[
				'title' => esc_html__( 'BWD General Group', BWDEB_PLUGIN_TD ),
				'icon' => 'eicon-person',
			]
		);
		$elements_manager->add_category(
			'bwdeb_post_category',
			[
				'title' => esc_html__( 'BWD Post Group', BWDEB_PLUGIN_TD ),
				'icon' => 'eicon-person',
			]
		);
		$elements_manager->add_category(
			...
			[
				'title' => esc_html__( 'BWD Woocommerce Group', BWDEB_PLUGIN_TD ),
				'icon' => 'eicon-person',
			]
		);
	}
	...
	public function bwdeb_all_assets_for_dashboard_admin($hook){
		...
		if ($hook != 'toplevel_page_bwdeb-plugin-main-menu' && $hook != 'dashboard_page_bwdes_104_email_subscription') {
			return;
		}
