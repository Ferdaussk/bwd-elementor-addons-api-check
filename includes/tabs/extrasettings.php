...
$supportCheck = $screen && $screen->id != 'dashboard_page_bwdes_104_email_subscription'?'bwd-admin-setting-tab':'';
			...
			echo '<div class="bwd-style-int bwd-col-xxl-4 bwd-col-xl-4 bwd-col-lg-6 bwd-col-md-6">';
				echo '<div class="bwd-extrasettings-wrap">';
					...
					echo '<div class="bwd-extrasettings-action-switch">';
						...
						echo '<a href="'.$getExtra['video'].'"><img src="'.esc_url(plugin_dir_url( __FILE__ ).'../../assets/admin/dashboard/images/video.svg').'" alt=""></a>';
