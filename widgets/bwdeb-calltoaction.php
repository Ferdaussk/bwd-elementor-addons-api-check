	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a class="bwdeb-pro-promotion-text" href="https://bestwpdeveloper.com/call-to-action-for-elementor/" target="_blank"><b>Demo</b></a>. Get <a class="bwdeb-pro-promotion-text" href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>Pro...</b></a>.',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Button Two Link', 'bwd-elementor-addons' ),
				'type' => \Elementor\Controls_Manager::URL,
				'placeholder' => esc_html__( 'https://your-link.com', 'bwd-elementor-addons' ),
				'label_block' => true,
				'dynamic' => [
