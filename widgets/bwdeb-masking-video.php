	   ...
	   $this->add_control(
		   ...
		   [
			   ...
			   'options' => [
				...
				'description' => 'See <a class="bwdeb-pro-promotion-text" href="https://bestwpdeveloper.com/masking-video-addon-for-elementor/" target="_blank"><b>Demo</b></a>. Get <a class="bwdeb-pro-promotion-text" href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>Pro...</b></a>.',
				]
	   );
	   	//mask position
	   $this->add_responsive_control(
