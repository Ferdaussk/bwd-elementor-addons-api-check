	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'description' => 'See <a class="bwdeb-pro-promotion-text" href="https://bestwpdeveloper.com/pre-loader" target="_blank"><b>Demo</b></a>. Get <a class="bwdeb-pro-promotion-text" href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>Pro...</b></a>.',
			]
		);
		$repeater->add_control(
			'plcprecentagelayout',
