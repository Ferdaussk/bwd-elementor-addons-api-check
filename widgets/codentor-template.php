	...
	protected function _register_controls(){
		...
		$this->add_control(
			...
			[
				...
				'default' => 'Default',
				'description' => 'See <a class="bwdeb-pro-promotion-text" href="https://bestwpdeveloper.com/code-highlighter" target="_blank"><b>Demo</b></a>. Get <a class="bwdeb-pro-promotion-text" href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>Pro...</b></a>.',
			]
		);
		$this->add_control(
			'codentor_language',
